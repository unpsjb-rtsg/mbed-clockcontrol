...
OBJECTS += ./CoreMark/core_list_join.o
OBJECTS += ./CoreMark/core_main.o
OBJECTS += ./CoreMark/core_matrix.o
OBJECTS += ./CoreMark/core_portme.o
OBJECTS += ./CoreMark/core_state.o
OBJECTS += ./CoreMark/core_util.o
OBJECTS += ./CoreMark/cvt.o
OBJECTS += $(FREERTOS_SRC:.c=.o)
OBJECTS += $(TRACEALYZER_SRC:.c=.o)
...
CLOCKCONTROL_INCLUDE_PATHS += -I./ClockControl

COREMARK_INCLUDE_PATHS += -I./CoreMark
...
INCLUDE_PATHS += $(CLOCKCONTROL_INCLUDE_PATHS)
INCLUDE_PATHS += $(COREMARK_INCLUDE_PATHS)
